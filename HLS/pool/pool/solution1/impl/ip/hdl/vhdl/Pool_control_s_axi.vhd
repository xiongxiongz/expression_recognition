...
architecture behave of Pool_control_s_axi is
    ...
    constant ADDR_KX_DATA_0          : INTEGER := 16#28#;
    constant ADDR_KX_CTRL            : INTEGER := 16#2c#;
    constant ADDR_KY_DATA_0          : INTEGER := 16#30#;
    constant ADDR_KY_CTRL            : INTEGER := 16#34#;
    constant ADDR_MODE_DATA_0        : INTEGER := 16#38#;
    constant ADDR_MODE_CTRL          : INTEGER := 16#3c#;
    constant ADDR_FEATURE_IN_DATA_0  : INTEGER := 16#40#;
    constant ADDR_FEATURE_IN_DATA_1  : INTEGER := 16#44#;
    constant ADDR_FEATURE_IN_CTRL    : INTEGER := 16#48#;
    constant ADDR_FEATURE_OUT_DATA_0 : INTEGER := 16#4c#;
    constant ADDR_FEATURE_OUT_DATA_1 : INTEGER := 16#50#;
    constant ADDR_FEATURE_OUT_CTRL   : INTEGER := 16#54#;
    ...
    signal int_mode            : UNSIGNED(1 downto 0) := (others => '0');
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_MODE_DATA_0 =>
                        rdata_data <= RESIZE(int_mode(1 downto 0), 32);
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MODE_DATA_0) then
                    int_mode(1 downto 0) <= (UNSIGNED(WDATA(1 downto 0)) and wmask(1 downto 0)) or ((not wmask(1 downto 0)) and int_mode(1 downto 0));
                end if;
            end if;
        end if;
    end process;
