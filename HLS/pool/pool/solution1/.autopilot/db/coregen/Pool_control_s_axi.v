...
localparam
    ...
    ADDR_IER                = 7'h08,
    ADDR_ISR                = 7'h0c,
    ADDR_CHIN_DATA_0        = 7'h10,
    ADDR_CHIN_CTRL          = 7'h14,
    ADDR_HIN_DATA_0         = 7'h18,
    ADDR_HIN_CTRL           = 7'h1c,
    ADDR_WIN_DATA_0         = 7'h20,
    ADDR_WIN_CTRL           = 7'h24,
    ADDR_KX_DATA_0          = 7'h28,
    ADDR_KX_CTRL            = 7'h2c,
    ADDR_KY_DATA_0          = 7'h30,
    ADDR_KY_CTRL            = 7'h34,
    ADDR_MODE_DATA_0        = 7'h38,
    ADDR_MODE_CTRL          = 7'h3c,
    ADDR_FEATURE_IN_DATA_0  = 7'h40,
    ADDR_FEATURE_IN_DATA_1  = 7'h44,
    ADDR_FEATURE_IN_CTRL    = 7'h48,
    ADDR_FEATURE_OUT_DATA_0 = 7'h4c,
    ADDR_FEATURE_OUT_DATA_1 = 7'h50,
    ADDR_FEATURE_OUT_CTRL   = 7'h54,
    WRIDLE                  = 2'd0,
    WRDATA                  = 2'd1,
    WRRESP                  = 2'd2,
    WRRESET                 = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_MODE_DATA_0)
            int_mode[1:0] <= (WDATA[31:0] & wmask) | (int_mode[1:0] & ~wmask);
    end
end
