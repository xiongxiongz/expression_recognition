...
set id 4
set name Pool_mac_muladd_16s_16ns_16ns_48_4_1
...
set ce_signed 0
set out_width 48
set arg_lists {i0 {16 1 +} i1 {16 0 +} m {32 1 +} i2 {16 0 +} p {48 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
...
set id 7
set name Pool_mul_mul_16s_16ns_32_4_1
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { select_ln25_1 { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_zext_ln1495 \
    op interface \
    ports { zext_ln1495 { I 16 vector } } \
} "
}
...
set InstName Pool_flow_control_loop_pipe_sequential_init_U
set CompName Pool_flow_control_loop_pipe_sequential_init
