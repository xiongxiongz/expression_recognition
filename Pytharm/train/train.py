...
# 获取照片路径
imagepaths = []
for dirname, _, filenames in os.walk('G:/expression_recognition/Pytharm/jaffe'):
...
for i in range(500):
    batch = np.random.choice(range(192), size=batch_size)
    # batch = 64
